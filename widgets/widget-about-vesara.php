...
class About_Vesara_Widget extends Widget_Base {
    ...
    protected function register_controls(): void {
        ...
        $this->add_control( 'about_vesara_img_size_heading', [
            'label'     => esc_html__( 'Image Size', 'vesara-silks-widgets' ),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ] );

        $this->add_responsive_control( 'about_vesara_img_max_width', [
        ...
        $this->add_responsive_control( 'about_vesara_img_width', [
        ...
        $this->add_responsive_control( 'about_vesara_img_height', [
        ...
        $this->add_control( 'about_vesara_img_object_fit', [
