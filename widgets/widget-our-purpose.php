...
class Our_Purpose_Widget extends Widget_Base {
    ...
    public function get_name(): string {
        return 'vsw_our_purpose';
    }

    public function get_title(): string {
        return esc_html__( 'Vesara — Our Purpose', 'vesara-silks-widgets' );
    }
    ...
    public function get_keywords(): array {
        return [ 'vesara', 'purpose', 'about', 'silk', 'brand' ];
    }
    ...
    protected function render(): void {
        ...
        $icon_class = esc_attr( $settings['purpose_icon'] );
            ...
            <div class="vsw-section-wrap <?php echo esc_attr( $img_pos ); ?>">
                ...
                <div class="vsw-section-media">
                    ...
                    <img class="vsw-section-img"
                         src="<?php echo esc_url( $settings['purpose_image']['url'] ); ?>"
                         alt="<?php echo esc_attr( $settings['purpose_title'] ); ?>"
                         loading="lazy">
                    <?php endif; ?>
                </div>
    ...
    protected function content_template(): void {
        ...
        var iconClass = settings.purpose_icon;
        ...
        <div class="vsw-section-outer">
            <div class="vsw-section-wrap {{ imgPos }}">
                ...
                <div class="vsw-section-media">
                    ...
                    <img class="vsw-section-img"
                         src="{{ settings.purpose_image.url }}"
                         alt="{{ settings.purpose_title }}">
                    <# } #>
                </div>
