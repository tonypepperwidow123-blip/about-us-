...
class Our_Purpose_Widget extends Widget_Base {
    ...
    protected function register_controls(): void {
        ...
        $this->add_control( 'show_purpose_line', [
        ...
        $this->add_responsive_control( 'purpose_line_margin', [
        ...
        $this->add_control( 'purpose_img_size_heading', [
            'label'     => esc_html__( 'Image Size', 'vesara-silks-widgets' ),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ] );

        $this->add_responsive_control( 'purpose_img_max_width', [
        ...
        $this->add_responsive_control( 'purpose_img_width', [
        ...
        $this->add_responsive_control( 'purpose_img_height', [
        ...
        $this->add_control( 'purpose_img_object_fit', [
        ...
        <div class="vsw-section-outer">
            <div class="vsw-section-wrap <?php echo esc_attr( $img_pos ); ?>">
                <div class="vsw-section-text">
                    ...
                    <?php if ( 'yes' === $settings['show_purpose_line'] ) : ?>
        ...
        <div class="vsw-section-outer">
            <div class="vsw-section-wrap {{ imgPos }}">
                <div class="vsw-section-text">
                    ...
                    <# if ( 'yes' === settings.show_purpose_line ) { #>
                    <span class="vsw-title-rule" aria-hidden="true"></span>
                    <# } #>
                    <div class="vsw-section-body">
